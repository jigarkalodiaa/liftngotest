...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Booking on Liftngo is simple: 1) Visit goliftngo.in or open the app, 2) Enter pickup and drop location, 3) Select vehicle type (bike, auto, mini truck), 4) See upfront fare and confirm booking, 5) Track your delivery in real-time. You can also book via WhatsApp for quick orders.',
  },
  {
