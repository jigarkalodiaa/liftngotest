...
export const MARKETING_PATHS: { path: string; priority: number; changeFrequency: 'always' | 'hourly' | 'daily' | 'weekly' | 'monthly' | 'yearly' | 'never' }[] = [
  ...
  { path: '/for-hotels', priority: 0.88, changeFrequency: 'weekly' },
  { path: '/for-restaurants', priority: 0.88, changeFrequency: 'weekly' },
  { path: '/for-suppliers', priority: 0.88, changeFrequency: 'weekly' },
