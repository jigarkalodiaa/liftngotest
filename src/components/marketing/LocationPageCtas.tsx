...
/** Conversion row: primary Book + optional WhatsApp when configured. */
export default function LocationPageCtas({
  whatsappSource,
  whatsappPrefill = 'Hi, I want to book a delivery with Liftngo.',
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-center">
      <TrackedLink
        ...
        trackSource={bookTrackSource ?? whatsappSource}
      ...
      <WhatsAppButton trackSource={whatsappSource} prefillMessage={whatsappPrefill} variant="primary">
